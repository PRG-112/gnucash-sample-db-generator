...
By default, the generator is set to USD and starts as of 1-JAN-2023 (WARNING: if your default currency is different, reports won't show anything until you change the commodity in the report's settings / properties). If you're looking for something different, edit the generator's code lines:
